...
<div class="container-fluid">
    ...
    <form action="" method="POST" id="backAdmin">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input type="usertype" required="required" name="usertype" class="form-control" value="<?php echo $fm->validation($value['usertype']); ?>" placeholder="Confirm Usertype">
            </div>


        </div>
        <div class="modal-footer">
            <a href="<?php echo $_SERVER['PHP_SELF']?>?"><button type="button" class="btn btn-info" data-dismiss="modal"><i class="fas fa-undo"></i>  Vazgeç </button></a>
